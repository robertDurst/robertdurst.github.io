...
A nice table summarizing type compatibility for a large set of programming languages: [Comparison of programming languages by type system - Wikipedia](https://en.wikipedia.org/wiki/Comparison_of_programming_languages_by_type_system).
