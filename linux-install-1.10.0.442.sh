...
curl -O https://download.clojure.org/install/clojure-tools-1.10.0.442.tar.gz
tar xzf clojure-tools-1.10.0.442.tar.gz
...
install -Dm644 clojure-tools/clojure-tools-1.10.0.442.jar "$clojure_lib_dir/libexec/clojure-tools-1.10.0.442.jar"
